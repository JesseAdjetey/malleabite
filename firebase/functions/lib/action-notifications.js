...
exports.sendPendingActionNotifications = exports.onCalendarEventActionWritten = void 0;
 ...
 */
exports.onCalendarEventActionWritten = (0, firestore_1.onDocumentWritten)('calendar_events/{eventId}', async (event) => {
    ...
    const startsAt = afterData.startsAt;
    if (!startsAt)
        return;
 ...
 */
exports.sendPendingActionNotifications = functionsV1.pubsub
...
//# sourceMappingURL=action-notifications.js.map